...
import { withCopy } from '../../components/CopyButton';

const sampleHash = '6Ze8pqYi4CAuwdm4eTGxKke7LSF6phkzmERUmpG5tTC1yKoh';
  
const Summary = () => {
    return <SummaryPaper data={[
        {label: 'stash', value: withCopy(sampleHash, <AvatarLabel src='???' srcAlt='lala' text={sampleHash}/>)},
        {label: 'controller', value: withCopy(sampleHash, <AvatarLabel src='???' srcAlt='lala' text={sampleHash}/>)},
        {label: 'reward', value: withCopy(sampleHash, <AvatarLabel src='???' srcAlt='lala' text={sampleHash}/>)},
        {label: 'cmix id', value: withCopy('kgGYMH8rxprBOvOvGAZI2chj5xJI71CqIM34DpCII10C', <Typography>kgGYMH8rxprBOvOvGAZI2chj5xJI71CqIM34DpCII10C</Typography>)},
