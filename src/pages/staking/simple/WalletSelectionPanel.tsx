...
import { Typography, Radio, Stack, Table, TableCell, TableHead, TableBody, TableRow, Button } from '@mui/material';
...
const WalletSelection: FC<Props> = ({ onSelect, selected }) => {
  ...
  const forget = useCallback((acct: string) => () => {
                  ...
                  <TableCell>
                    <Stack alignItems='center' direction='row'>
                      <Radio
                        ...
                        value={acct}
                      />
                      <Button size='small' color='error' onClick={forget(acct)} sx={{ minWidth: 0 }}>
                        <Close color='error' />
                      </Button>
                    </Stack>
                  </TableCell>
