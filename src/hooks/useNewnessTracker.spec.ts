...
const newItems = [{id: 'one', value: 1 }, { id: 'four', value: 4 }, { id: 'five', value: 5 }];
const lastItems = [{ id: 'six', value: 6 }, { id: 'seven', value: 7 }, { id: 'four', value: 4 }, { id: 'five', value: 5 }];

test(`${useNewnessTracker.name} hook`, async () => {
  const hook = renderHook((i: Item[] = items) => useNewnessTracker(i, 'id'));

  hook.rerender(newItems);
